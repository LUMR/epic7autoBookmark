...
def test_mystic():
    print("=" * 50)
    print("mysticLocation confidence test")
    print("=" * 50)
    ...
    template = aircv.imread("./img/mysticLocation.png")
    if template is None:
        print("error: cannot load template ./img/mysticLocation.png")
        return

    print("template loaded: mysticLocation.png")
    ...
    cv2.imwrite("test_mystic_screenshot.png", screenshot)
    print("\nscreenshot saved: test_mystic_screenshot.png")
