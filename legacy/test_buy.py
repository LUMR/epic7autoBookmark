...
def test_buy():
    print("=" * 50)
    print("buyButton confidence test")
    print("=" * 50)
    ...
    print(f"template loaded: buyButton-{e7_language}.png")
    ...
    cv2.imwrite("test_buy_screenshot.png", screenshot)
    print("\nscreenshot saved: test_buy_screenshot.png")
