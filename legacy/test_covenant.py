...
def test_covenant():
    print("=" * 50)
    print("covenantLocation confidence test")
    print("=" * 50)
    ...
    template = aircv.imread("./img/covenantLocation.png")
    if template is None:
        print("error: cannot load template ./img/covenantLocation.png")
        return

    print("template loaded: covenantLocation.png")
    ...
    cv2.imwrite("test_covenant_screenshot.png", screenshot)
    print("\nscreenshot saved: test_covenant_screenshot.png")
